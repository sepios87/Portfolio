    ...
    return (
      ...
      <ParallaxProvider >
        ...
        <Parallax y={matches ? [-60, -120] : [0, -20]}>
          <Carte source="./images/Pilaf.png" lien="https://sawangg.github.io/Pilaf/" nom="Projet Pilaf" txt="Projet scolaire réalisé avec un client factice. Ce site est 
            pensé pour répondre aux besoins d'une application de gestion web. Nous avons réalisé ce projet en équipe de 4 sur une durée de 2 mois." langage={["./svg/030-html-5.svg", "./svg/031-css.svg"]}/>
      </Parallax>
      <Parallax y={matches ? [30, -100] : [0, -20]}>
          <Carte source="./images/FollementTpsDanse.png" lien="https://follement-temps-danse.com/" nom="Follement temps danse" txt="Site réalisé avec l'association Follement Temps Danse 
            association de danse à Versailles. Réalisé avec du WordPress. C'est un site vitrine qui correspond à la refonte d'un ancien site web (en reprenant une logique de couleurs et de contenu)." langage={["./svg/wordpress.svg"]}/>
      </Parallax>
        </div>
        ...
        <Parallax y={matches ? [0, -120] : [0, -10]} x={matches ? [-15, -15] : [0, 0]}>
          ...
          jeu Space Invaders : un jeu rétro avec des extraterrestres !" langage={["./svg/003-java.svg"]}/>
      </Parallax>
      <Parallax y={matches ? [20, -60] : [0, -20]} x={matches ? [-30, -30] : [0, 0]}>
          ...
          Cette one-page devait être le site vitrine de l'association Cambava, un producteur de limonade. Nous l'avons réalisé en groupe de 3 sur une durée d'un mois." langage={["./svg/030-html-5.svg", "./svg/031-css.svg"]}/>
      </Parallax>
        </div>
        <div className="projet">
        <Parallax y={matches ? [0, -70] : [0, -15]} x={matches ? [0, 0] : [0, 0]}>
          ...
          Je le présente sur ce portfolio car même si le code n'est pas le plus beau, cela montre qu'on commence à un moment et c'est source de nostalgie !" langage={["./svg/003-java.svg"]}/>
      </Parallax>
      <Parallax y={matches ? [80, -70] : [0, -30]} x={matches ? [-10, -10] : [0, 0]}>
          ...
          A travers ce portfolio, j'ai voulu m'exprimer pleinement et j'ai donc créé une véritable identité graphique liant mon CV à mon portfolio." langage={["./svg/006-react.svg"]}/>
      </Parallax>
        </div>
        </div>
      </ParallaxProvider>
