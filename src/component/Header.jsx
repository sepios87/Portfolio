...
export default function Header(props){
  ...
  const txt2 = 'C:\\Florian\\'+props.job+'>profil'
    ...
    return (
          ...
          <IconButton href="#home" style={{zIndex : "10", position: "fixed", bottom :"30px", right : "30px"}} variant="contained"><ExpandLessIcon style={{backgroundColor : "rgba(3, 219, 252, 0.1)", borderRadius :"10px", width: "35px", height: "35px"}}/></IconButton>
        </div>
    );
}